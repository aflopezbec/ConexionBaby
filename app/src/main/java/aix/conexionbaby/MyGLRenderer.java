...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        final float eyeX = 3.2f;
        final float eyeY = 2.8f;
        final float eyeZ = 3f;
        ...
        Matrix.rotateM(mRotationMatrix, 0, (SystemClock.uptimeMillis() % 6000L) * 0.060f, 0.0f, 0.1f, 0.0f);
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Log.d("MEDIDAS------------>",width+"-"+height);
        GLES20.glViewport(0, 0, width, height*3);

        float ratio = (float) width / (height*3);
